...
fetch('http://139.84.137.232/api/login', {
  method: 'POST',
...
// console.log("You have entered an invalid email address!");
  ...
  return (
    ...
    <Box className="Registration" sx={{backgroundColor:'',padding:{xs:'20px'}}}>
        
        
        
        
       
        <div  className="regbox0" style={{ display:'flex',gap:'20px', alignItems:'center', padding:{xs:'20px'}}}>
       ...
       <div className="regbox1" style={{background:'transparent'}}>
           ...
           <div style={{color:'grey', fontSize:'18px', padding:'20px'}}>Login in your <span style={{color:'#5661FF'}}>BCEX Account</span></div>
...
<input placeholder='Password' 
        ...
        margin='dense'
        style={{background:'transparent',padding:'15px',width:'38ch' ,margin:'7px', border:'1px solid grey'}}
       variant="outlined"/>
              </div>
             <div style={{color:'grey', fontSize:'9px'}}> <FormControlLabel  control={<Checkbox   size="small" defaultChecked />} label="Bind IP (Security Option)" /></div>
