    ...
    <>
      ...
      >
        ...
        >
          ...
          <Box sx={{ color: (bg == '#ffffff'? '#ffffff':'grey'), fontSize: '16px' }}> $ 569.87</Box>
        </Box>
        ...
        >
          ...
          <Box sx={{ color: (bg == '#ffffff'? '#ffffff':'grey'), fontSize: '16px' }}> $ 206.55</Box>
        </Box>
        ...
        >
          ...
          <Box sx={{ color:(bg == '#ffffff'? '#ffffff':'grey'), fontSize: '16px' }}> $ 359.09</Box>
        </Box>
        ...
        >
          ...
          <Box sx={{ color: (bg == '#ffffff'? '#ffffff':'grey'), fontSize: '16px' }}> 12%</Box>
        </Box>
      </Box>
    </>
  )
