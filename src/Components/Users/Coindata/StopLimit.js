...
//           <input type="number"  placeholder={context.symbol} style={{background:'transparent',padding:'15px',width:'48ch' ,margin:'10px', border:'1px solid grey'}} />
//           </div>

//           <div>

// <input type="number"  placeholder="Amount" style={{background:'transparent',margin:'10px',padding:'15px' ,width:'48ch', border:'1px solid grey'}} />
// </div>
// <div>

// <input type="number"  placeholder="Amount" style={{background:'transparent',padding:'15px' ,margin:'10px',width:'48ch', border:'1px solid grey'}} />
// </div>
// <div>
...
// <input type="number"  placeholder={context.symbol} style={{background:'transparent',margin:'10px',width:'48ch',padding:'15px' , m:"1", border:'1px solid grey'}} />
// </div>
