...
const [color, setColor] = useState('#171B26')
  ...
  <Grid onClick={hidetoggle} item xs={12} className='gridbox' sx={{  "&:hover": {
       background: "#18192B"
     }}} >
...
<Box  style={{backgroundColor:color , zIndex:'5',position:'fixed', borderBottom:'1px solid #2A2F3F', width:'100%', height:'7vh'}} >
...
<Box sx={{display:{xs:'none',sm:'flex'}, alignItems:'center', width:'50%'}}>
<Box>
...
<Box style={{display:'flex',justifyContent:'flex-end', color:'#7D8794', width:'50%'}}>
