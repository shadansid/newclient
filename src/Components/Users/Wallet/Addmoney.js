  ...
  .catch(function (error) {
    ...
    <div style={{padding:'20px'}}><Typography sx={{fontSize:'25px',color:'#7D8794'}}>Add Money</Typography></div>
        ...
        <Select style={{height:'40px' , width:'18%', marginRight:'1px', color:'#7D8794', border:'1px solid grey',backgroundColor:'none'}}
          ...
          >
          <MenuItem sx={{display:'flex', alignItems:'center'}} value={"usdt"}> <img src="http://139.84.137.232/api/static/images/coinimage/USDT.png"  height='20px' width='20px' alt="" />&nbsp; USDT </MenuItem>

          <MenuItem sx={{display:'flex', alignItems:'center'}} value={"btc"}><img src="http://139.84.137.232/api/static/images/coinimage/BTC.png"  height='20px' width='20px' alt="" />&nbsp; BTC</MenuItem>
          <MenuItem sx={{display:'flex', alignItems:'center'}} value={"eth"}><img src="http://139.84.137.232/api/static/images/coinimage/ETH.png"  height='20px' width='20px' alt="" />&nbsp; ETH</MenuItem>
        </Select>
