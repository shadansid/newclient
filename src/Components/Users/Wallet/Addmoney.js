...
const Addmoney = () => {
  ...
  const addmn = async () => {
    ...
    const response = await axios.post('http://139.84.137.232/api/addrstoreact', {
      amount: inputValue,
      currency: age
    }, {
          ...
          <Container style={{ padding: '30px', display: 'flex', flexDirection: 'column' }}>
            <div style={{ width: '100%', display: 'flex', alignItems: 'center' }}>
              ...
              >
                ...
                <MenuItem sx={{ display: 'flex', alignItems: 'center', color: 'grey' }} value={"btc"}><img src="http://139.84.137.232/api/static/images/coinimage/BTC.png" height='15px' width='15px' alt="" />&nbsp; BTC</MenuItem>
                <MenuItem sx={{ display: 'flex', alignItems: 'center', color: 'grey' }} value={"eth"}><img src="http://139.84.137.232/api/static/images/coinimage/ETH.png" height='15px' width='15px' alt="" />&nbsp; ETH</MenuItem>
